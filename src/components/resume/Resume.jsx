        ...
        <main className="md:col-span-3 space-y-12">
          ...
          <section>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc ml-6 space-y-2 text-sm">
                ...
                <li>
                  Boosted e-commerce site performance by 30% and user engagement
                  by 20%.
                </li>
                <li>
            ...
            <div>
              <h3 className="text-xl font-bold">BlackWater Coffee Pvt. Ltd.</h3>
              <p className="text-sm text-gray-500 mb-2">
          ...
          <section>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <strong>Audit Management System:</strong> Real-time auditing and
                assignment platform with media uploads, analytics, and
                microservices.{" "}
                <a
          ...
          <section>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <strong>Senior Secondary (XII)</strong>, Deochand Mahavidyalaya
                · 2016–2018 · 70%
                <p className="text-sm text-gray-500">
