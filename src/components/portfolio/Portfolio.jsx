...
import { FaGithub, FaExternalLinkAlt,  FaEye, FaCode, FaStar } from "react-icons/fa";
...
const Portfolio = () => {
  ...
  const featuredProjects = [
    {
      ...
      description: "A full-stack e-commerce solution with modern UI/UX, shopping cart, and payment integration.",
    ...
    },
    {
      ...
      description: "A modern URL shortening service with analytics, custom domains, and QR code generation.",
    ...
    },
    {
      ...
      description: "A feature-rich note-taking app with real-time sync, labels, and advanced search functionality.",
    ...
    },
    {
      ...
      description: "A comprehensive todo application with user authentication, categories, and progress tracking.",
  ...
  return (
    <>
      ...
      <section id="portfolio" className="py-12 md:py-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-4 max-w-2xl mx-auto">
              Here are some of my best projects that showcase my skills in full-stack development, 
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-lg">
                    Explore my complete portfolio with detailed project breakdowns, 
          ...
          {/* Stats */}
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-12 md:mt-16 transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-1 md:mb-2">15+</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Projects</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-1 md:mb-2">50+</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Repositories</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-1 md:mb-2">10+</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Live Demos</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-200 mb-1 md:mb-2">4</h3>
              <p className="text-sm md:text-base text-gray-600 dark:text-gray-400">Featured</p>
            </div>
          </div>
        </div>
      </section>
