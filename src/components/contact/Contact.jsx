...
const Contact = () => {
    ...
    return (
      ...
      >
        <div className="text-center">
          <div
            className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-r ${option.color} flex items-center justify-center shadow-lg`}
          >
  ...
  return (
    <>
      ...
      <section
        id="contact"
        className="py-12 md:py-20 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900 relative overflow-hidden"
      >
